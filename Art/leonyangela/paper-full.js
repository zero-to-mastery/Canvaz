...
var paper = new (function (undefined) {
  var Base = new (function () {
    ...
    function each(obj, iter, bind) {
      if (obj)
        ('length' in obj && !obj.getLength && typeof obj.length === 'number'
          ? forEach
          : forIn
      ...
      },
      {
        ...
        extend: function () {
          var base = this,
            ...
            proto;
          for (var i = 0, l = arguments.length; i < l; i++)
            if ((ctor = arguments[i].initialize)) break;
          ctor =
            ctor ||
            function () {
    ...
    statics: {
      ...
      importJSON: function (json, target) {
        return Base.deserialize(
          ...
          function (type, args) {
            var obj =
                target && target.constructor === type
                  ? target
      ...
      statics: {
        ...
        isCollinear: function (x1, y1, x2, y2) {
          return (
            ...
            Math.sqrt((x1 * x1 + y1 * y1) * (x2 * x2 + y2 * y2)) * 1e-7
          );
        },
  ...
  var Item = Base.extend(
      ...
      },
      {
          ...
          for (var i = 0, l = children.length; i < l; i++) {
            ...
            if (child._visible && !child.isEmpty()) {
              var rect = child._getCachedBounds(
                getter,
                matrix && matrix.chain(child._matrix),
                cacheItem
              );
        ...
        _getCachedBounds: function (getter, matrix, cacheItem, internalGetter) {
          ...
          Item._updateBoundsCache(
            this._parent || this._parentSymbol,
            cacheItem
          );
          if (cache && this._bounds && this._bounds[cache])
            return this._bounds[cache].clone();
          var bounds = this._getBounds(
            internalGetter || getter,
            matrix || _matrix,
            cacheItem
          );
          if (cache) {
    ...
    },
    {
      ...
      getNextSibling: function () {
        return (
          (this._parent && this._parent._children[this._index + 1]) || null
        );
      },
      ...
      getItem: function (match) {
        return (
          Item._getItems(this._children, match, this._matrix, null, true)[0] ||
          null
        );
      },
      ...
      statics: {
        _getItems: function _getItems(
          ...
          if (!param && typeof match === 'object') {
            ...
            if (bounds)
              match = Base.set({}, match, { inside: true, overlapping: true });
          }
    ...
    },
    {
      ...
      sendToBack: function () {
        return (
          this._parent ||
          (this instanceof Layer && this._project)
        ).insertChild(0, this);
      },
      ...
      function (name) {
        this[name] = function () {
          var point = Point.read(arguments),
            center = Point.read(arguments, 0, { readNull: true });
          return this.transform(
            new Matrix()[name](point, center || this.getPosition(true))
          );
        };
      },
      {}
    ),
    {
      transform: function (
        ...
        if (
          (applyMatrix =
            applyMatrix &&
            this._transformContent(_matrix, _applyRecursively, _setApplyMatrix))
        ) {
          var pivot = this._pivot,
            style = this._style,
        ...
        if (decomp && !decomp.shearing && decomp.rotation % 90 === 0) {
          ...
          var getter = this._boundsGetter,
            rect =
              bounds[(getter && getter.getBounds) || getter || 'getBounds'];
  ...
  var Layer = Group.extend({
    ...
    getNextSibling: function getNextSibling() {
      return this._parent
        ? getNextSibling.base.call(this)
        : this._project.layers[this._index + 1] || null;
    },

    getPreviousSibling: function getPreviousSibling() {
      return this._parent
        ? getPreviousSibling.base.call(this)
        : this._project.layers[this._index - 1] || null;
    },
          ...
          if (this.hasStroke()) {
            ...
            if (type === 'rectangle') {
              ...
              if (center) {
                ...
                hit =
                  2 * Math.abs(pt.getLength() - getEllipseRadius(pt, radius)) <=
                  strokeWidth;
              } else {
                var rect = new Rectangle(this._size).setCenter(0, 0),
  ...
  var Raster = Item.extend(
    {
      ...
      getCrossOrigin: function () {
        return (
          (this._image && this._image.crossOrigin) || this._crossOrigin || ''
        );
      },
  ...
  var PlacedSymbol = Item.extend({
    ...
    _getBounds: function (getter, matrix, cacheItem) {
      ...
      return definition._getCachedBounds(
        getter,
        matrix && matrix.chain(definition._matrix),
        cacheItem
      );
    },
  ...
  var Segment = Base.extend({
    ...
    isSelected: function (_point) {
      ...
      return !_point
        ...
        : _point === this._point
        ? !!(state & 4)
        : _point === this._handleIn
        ? !!(state & 1)
        : _point === this._handleOut
        ? !!(state & 2)
        : false;
    },
  ...
  var Curve = Base.extend(
      ...
      statics: {
        ...
        getParameterOf: function (v, point) {
          var p1 = new Point(v[0], v[1]),
            ...
            epsilon = 1e-12,
            t = point.isClose(p1, epsilon)
              ? 0
              : point.isClose(p2, epsilon)
              ? 1
              : null;
          if (t !== null) return t;
          ...
          return point.isClose(p1, geomEpsilon)
            ? 0
            : point.isClose(p2, geomEpsilon)
            ? 1
            : null;
        },
        ...
        getNearestParameter: function (v, point) {
          if (Curve.isStraight(v)) {
            ...
            return u < 1e-12
              ...
              : u > 0.999999999999
              ? 1
              : Curve.getParameterOf(v, new Point(p1x + u * vx, p1y + u * vy));
          }
    ...
    Base.each(
      ...
      function (test, name) {
        this[name] = function () {
          var seg1 = this._segment1,
            seg2 = this._segment2;
          return test(
            seg2._point.subtract(seg1._point),
            seg1._handleOut,
            seg2._handleIn
          );
        };
      ...
      },
      {
        ...
        isHorizontal: function () {
          return (
            this.isStraight() && Math.abs(this.getTangentAt(0.5, true).y) < 1e-7
          );
        },

        isVertical: function () {
          return (
            this.isStraight() && Math.abs(this.getTangentAt(0.5, true).x) < 1e-7
          );
        }
      }
    ),
    {
      ...
      getLocationOf: function () {
        return this.getLocationAt(
          this.getParameterOf(Point.read(arguments)),
          true
        );
      },
      ...
      return Base.each(
        ...
        function (name) {
          this[name + 'At'] = function (offset, isParameter) {
            ...
            return Curve[name](
              values,
              isParameter ? offset : Curve.getParameterAt(values, offset, 0)
            );
          };
        },
        {
      ...
      function addLocation(
        ...
        if (
          ...
          if (
            ...
            var loc1 = new CurveLocation(
                c1,
                t1,
                p1 || Curve.getPoint(v1, t1),
                overlap
              ),
              loc2 = new CurveLocation(
                c2,
                t2,
                p2 || Curve.getPoint(v2, t2),
                overlap
              ),
              flip =
                loc1.getPath() === loc2.getPath() &&
      ...
      return {
        statics: {
          ...
          _getSelfIntersection: function (v1, c1, locations, param) {
            ...
            if (side1 === side2) {
              var edgeSum =
                (p1x - h2x) * (h1y - p2y) + (h1x - p2x) * (h2y - p1y);
  ...
  var CurveLocation = Base.extend(
    {
      ...
      getSegment: function () {
        ...
        if (!segment) {
          ...
          if (parameter === 0) {
            ...
            segment =
              curve.getPartLength(0, parameter) <
      ...
      getCurve: function () {
        ...
        function trySegment(segment) {
          ...
          if (
            curve &&
            (that._parameter = curve.getParameterOf(that._point)) != null
          ) {
        ...
        if (
          ...
          res =
            ...
            (_ignoreOther ||
              ...
              (this._intersection &&
                this._intersection.equals(loc._intersection, true)));
        }
        return res;
      },
      ...
      for (var i = 0; i < length1; i++) {
        ...
        if (self) {
          Curve._getSelfIntersection(values1, curve1, locations, {
            include: include,
            startConnected:
              length1 === 1 && curve1.getPoint1().equals(curve1.getPoint2())
          });
        }
  ...
  var Path = PathItem.extend(
    ...
    },
    {
      ...
      _adjustCurves: function (from, to) {
        ...
        if (
          (curve =
            curves[this._closed && from === 0 ? segments.length - 1 : from - 1])
        ) {
      ...
      removeSegments: function (from, to, _includeCurves) {
        ...
        if (curves) {
          var index =
              from > 0 && to === count + (this._closed ? 1 : 0)
                ? from - 1
                : from,
      ...
      getArea: function () {
        if (this._area == null) {
          ...
          for (var i = 0, l = this._closed ? count : last; i < l; i++) {
            area += Curve.getArea(
              Curve.getValues(segments[i], segments[i < last ? i + 1 : 0])
            );
          }
          this._area = area;
        }
      ...
      isFullySelected: function () {
        ...
        return (
          this._selected &&
          length > 0 &&
          this._selectedSegmentState === length * 7
        );
      },
      ...
      reduce: function () {
        ...
        for (var i = curves.length - 1; i >= 0; i--) {
          ...
          if (
            !curve.hasHandles() &&
            (curve.getLength() === 0 || curve.isCollinear(curve.getNext()))
          )
            curve.remove();
        }
        return this;
      ...
      _hitTestSelf: function (point, options) {
        ...
        function checkSegmentStroke(segment) {
          if (join !== 'round' || cap !== 'round') {
            ...
            if (
              closed ||
              (segment._index > 0 && segment._index < numSegments - 1)
            ) {
              if (
                join !== 'round' &&
                (segment._handleIn.isZero() || segment._handleOut.isZero())
              )
                Path._addBevelJoin(
                  segment,
                  join,
        ...
        if (radius !== null) {
          ...
          if (!loc && join === 'miter' && numSegments > 1) {
            for (var i = 0; i < numSegments; i++) {
              ...
              if (
                point.getDistance(segment._point) <= miterLimit &&
    ...
    })(),
    {
      ...
      statics: {
        getBounds: function (segments, closed, style, matrix, strokePadding) {
          ...
          var coords = new Array(6),
            prevCoords = first._transformCoordinates(
              matrix,
              new Array(6),
              false
            ),
        ...
        getStrokeBounds: function (segments, closed, style, matrix) {
          ...
          function add(point) {
            bounds = bounds.include(
              matrix ? matrix._transformPoint(point, point) : point
            );
          }

          function addRound(segment) {
            bounds = bounds.unite(
              joinBounds.setCenter(
                matrix ? matrix._transformPoint(segment._point) : segment._point
              )
            );
          }
        ...
        _addSquareCap: function (segment, cap, radius, addPoint, area) {
          ...
          if (cap === 'square')
            point = point.add(
              normal.rotate(loc.getParameter() === 0 ? -90 : 90)
            );
          addPoint(point.add(normal));
          addPoint(point.subtract(normal));
        },
    ...
    },
    {
      ...
      getPathData: function (_matrix, _precision) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          paths.push(
            child.getPathData(
              _matrix && !mx.isIdentity() ? _matrix.chain(mx) : _matrix,
              _precision
            )
          );
        }
      ...
      _drawSelected: function (ctx, matrix, selectedItems) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!selectedItems[child._id])
            child._drawSelected(
              ctx,
              mx.isIdentity() ? matrix : matrix.chain(mx)
            );
        }
      }
    },
  ...
  PathItem.inject(
    new (function () {
      ...
      function computeBoolean(path1, path2, operation) {
        ...
        if (
          _path2 &&
          /^(subtract|exclude)$/.test(operation) ^
      ...
      function getWinding(point, curves, horizontal, testContains) {
        ...
        if (horizontal) {
          ...
          if (yBottom < Infinity)
            windRight = getWinding(
              new Point(px, yBottom),
              curves,
              false,
              testContains
            );
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  (t < tMin &&
                    slope * Curve.getTangent(curve.previous.values, 1).y < 0) ||
                  (t > tMax &&
                    slope * Curve.getTangent(curve.next.values, 0).y < 0)
                ) {
      ...
      function tracePaths(segments, operation) {
        ...
        for (var i = 0, l = segments.length; i < l; i++) {
          ...
          while (!finished) {
            ...
            inter =
              (inter &&
                (findBestIntersection(inter, true) ||
                  findBestIntersection(inter, false))) ||
              inter;
          ...
          if (
            path &&
            (path._segments.length > 8 || !Numerical.isZero(path.getArea()))
          ) {
            paths.push(path);
            path = null;
          }
        ...
        for (var l = this.parts.length; i < l; i++) {
          ...
          if (part.offset >= offset) {
            ...
            return {
              value:
                prevVal +
                ((part.value - prevVal) * (offset - prevLen)) /
                  (part.offset - prevLen),
              index: part.index
            };
          }
  ...
  DomEvent.requestAnimationFrame = new (function () {
    ...
    function handleCallbacks() {
      for (var i = callbacks.length - 1; i >= 0; i--) {
        ...
        if (
          !el ||
          ((PaperScope.getAttribute(el, 'keepalive') == 'true' || focused) &&
            DomElement.isInView(el))
        ) {
  ...
  var View = Base.extend(
    Emitter,
    {
      ...
      setZoom: function (zoom) {
        this._transform(
          new Matrix().scale(zoom / this._zoom, this.getCenter())
        );
        this._zoom = zoom;
      },
    ...
    new (function () {
      ...
      function handleMouseMove(view, point, event) {
        ...
        if (tool) {
          tool._handleEvent(
            dragging && tool.responds('mousedrag') ? 'mousedrag' : 'mousemove',
            point,
            event
          );
        }
        ...
        _installEvent: function (type) {
          ...
          if (counters) {
            for (var key in mouseFlags) {
              counters[key] =
                (counters[key] || 0) + (mouseFlags[key][type] || 0);
            }
          }
        },
      ...
      initialize: function CanvasView(project, canvas) {
        ...
        if (!/^off|false$/.test(PaperScope.getAttribute(canvas, 'hidpi'))) {
          var deviceRatio = window.devicePixelRatio || 1,
            backingStoreRatio =
              DomElement.getPrefixed(this._context, 'backingStorePixelRatio') ||
              1;
          ...
          switch (type) {
            ...
            case 'mouseup':
              ...
              if (!stopped && item && item === downItem) {
                ...
                callEvent(
                  this,
                  dblClick && downItem.responds('doubleclick')
                    ? 'doubleclick'
                    : 'click',
                  event,
                  downPoint,
  ...
  var Tool = PaperScopeItem.extend({
    ...
    _fireEvent: function (type, event) {
      ...
      return (
        this.responds(type) && this.emit(type, new ToolEvent(this, type, event))
      );
    },
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
          ...
          if (status === 0 || status === 200) {
            ...
            throw new Error(
              'Could not load ' + url + ' (Error ' + status + ')'
            );
          }
        }
      };
  ...
  new (function () {
    ...
    var importers = {
      ...
      text: function (node) {
        var text = new PointText(
          getPoint(node, 'x', 'y').add(getPoint(node, 'dx', 'dy'))
        );
    ...
    function applyOpacity(item, value, name) {
      var color =
        item[name === 'fill-opacity' ? 'getFillColor' : 'getStrokeColor']();
    ...
    var attributes = Base.set(
        ...
        function (entry) {
          this[entry.attribute] = function (item, value) {
            ...
            if (entry.type === 'color' && item instanceof Shape) {
              ...
              if (color)
                color.transform(
                  new Matrix().translate(item.getPosition(true).negate())
                );
            }
          };
        },
      ...
      ),
      {
        ...
        offset: function (item, value) {
          ...
          item.setRampPoint(
            percentage ? percentage[1] / 100 : parseFloat(value)
          );
        },
      ...
      function J() {
        ...
        switch (e) {
          ...
          case Yr:
            ...
            return (
              s && j(s, 'SwitchCase'), U(), Vr.pop(), j(r, 'SwitchStatement')
            );
          case Zr:
            return (
              U(),
            ...
            if ((U(), (r.block = H()), (r.handler = null), wr === Xr)) {
              ...
              U(),
                ...
                Tr &&
                  ...
                  t(
                    l.param.start,
                    'Binding ' + l.param.name + ' in strict mode'
                  ),
                z(vt),
                (l.guard = null),
                (l.body = H()),
      ...
      function ar() {
        switch (wr) {
          ...
          case jr:
            var e = q();
            return (
              (e.value = Cr), (e.raw = dr.slice(yr, gr)), U(), j(e, 'Literal')
            );
          case it:
          case st:
          case ct:
